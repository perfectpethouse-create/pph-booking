...
// รอบเริ่มทุกชั่วโมง เว้น 12:00 (พักกลางวัน) — บล็อกจองห่างกัน 1 ชม. ตรงกับหน้าเว็บ
// (เว็บใช้ endOf = เวลาเริ่ม + 1 ชม. คุมความจุ) แต่กิจกรรมจริงในรอบ = 50 นาที (เช่น 15:00–15:50)
export const EXERCISE_SLOTS = ['09:00', '10:00', '11:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00'];
export const EXERCISE_DURATION_MIN = 50; // เวลากิจกรรมต่อรอบ (ตรงกับเว็บ "รอบละ 50 นาที")
