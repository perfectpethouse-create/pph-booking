// ═══════════════════════════════════════════════════════════════
// icons.js — ชุดไอคอน SVG เส้นเดียวกันทั้งแอป (สไตล์ Lucide, stroke 1.8)
// กติกา UI: ห้ามใช้ emoji เป็นไอคอน — ใช้ SVG เพื่อความคมชัด/สม่ำเสมอทุกแพลตฟอร์ม
// ═══════════════════════════════════════════════════════════════

function svg(paths, viewBox = '0 0 24 24') {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="${viewBox}" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${paths}</svg>`;
}
...
export const icons = {
  ...
  bookings: svg('<rect x="8" y="2" width="8" height="4" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M12 11h4"/><path d="M12 16h4"/><path d="M8 11h.01"/><path d="M8 16h.01"/>'),
  ...
  backup: svg('<rect x="2" y="3" width="20" height="5" rx="1"/><path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"/><path d="M10 12h4"/>'),
  ...
  banknote: svg('<rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01"/><path d="M18 12h.01"/>'),
  ...
  dog: svg('<path d="M11.25 16.25h1.5L12 17z"/><path d="M16 14v.5"/><path d="M4.42 11.247A13.152 13.152 0 0 0 4 14.556C4 18.728 7.582 21 12 21s8-2.272 8-4.444a11.702 11.702 0 0 0-.493-3.309"/><path d="M8 14v.5"/><path d="M8.5 8.5c-.384 1.05-1.083 2.028-2.344 2.5-1.931.722-3.576-.297-3.656-1-.113-.994 1.177-6.53 4-7 1.923-.321 3.5.782 3.5 2.172"/><path d="M14.267 5.172c0-1.39 1.577-2.493 3.5-2.172 2.823.47 4.113 6.006 4 7-.08.703-1.725 1.722-3.656 1-1.261-.472-1.96-1.45-2.344-2.5"/>'),
  cat: svg('<path d="M12 5c.67 0 1.35.09 2 .26 1.78-2 5.03-2.84 6.42-2.26 1.4.58-.42 7-.42 7 .57 1.07 1 2.24 1 3.44C21 17.9 16.97 21 12 21s-9-3.1-9-7.56c0-1.25.5-2.4 1-3.44 0 0-1.89-6.42-.5-7 1.39-.58 4.72.23 6.5 2.23A9.04 9.04 0 0 1 12 5Z"/><path d="M8 14v.5"/><path d="M16 14v.5"/><path d="M11.25 16.25h1.5L12 17l-.75-.75Z"/>'),
...
// โลโก้ร้านตัวจริง (รูปบ้าน ไม่ใช่ไอคอนอุ้งเท้า) — ใช้ทุกที่ที่ต้องแสดงแบรนด์:
// หน้าล็อกอิน · แถบเมนู · ใบรับฝาก · ใบยืนยันเข้าพัก · การ์ดสรุปที่ส่งลูกค้า
// ⚠️ ห้ามใช้ icons.paw แทนโลโก้อีก — มันเป็นแค่ไอคอนประกอบเมนู "ลูกค้า & สัตว์เลี้ยง"
// ไฟล์นี้พื้นใส (คนละตัวกับ icons/icon-*.png ที่ต้องมีพื้นขาวสำหรับไอคอนแอป)
export const brandLogo = '<img src="icons/logo.png" alt="Perfect Pet House" class="brand-img" />';
