...
export async function renderSettings(container) {
  ...
  const staffCard = el('div', { class: 'card' }, [
    ...
    el('p', { class: 'muted', style: 'font-size:13px;margin-top:-6px', text:
      'อีเมลในลิสต์นี้ = พี่เลี้ยง จะเห็นเฉพาะเมนูที่ติ๊กเปิดไว้ข้างล่าง · รับจองและแจ้งราคาลูกค้าได้ ' +
      'แต่แก้/ลบใบที่บันทึกแล้วไม่ได้ (ต้องสร้างบัญชีให้เขาใน Firebase Console ก่อน) — ลิสต์ว่าง = ทุกคนเป็นเจ้าของร้าน' }),
  ]);
